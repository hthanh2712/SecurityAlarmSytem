...
API functions that have the potential to cause a context switch (for example, x\+Task\+Delay\+Until(), x\+Queue\+Send(), etc.) must not be called while the scheduler is suspended.
