...
/**
 * @brief Print a vector of complexes as ordered pairs.
 * 
 * @param title Name of the vector
 * @param x Complex part
 * @param n Real part
 */
static void
print_vector(
...
/**
 * @brief Factored discrete Fourier transform, or FFT, and its inverse iFFT
 * 
 * @return int 
 */
int
